...
use rp235x_hal::{self as hal, entry, Spi};
...
fn main() -> ! {
    ...
    let spi_sclk = pins.gpio34.into_function::<FunctionSpi>();
    let spi_mosi = pins.gpio35.into_function::<FunctionSpi>();
    let spi_miso = pins.gpio36.into_function::<FunctionSpi>();
    ...
    let spi_cs = pins.gpio33.into_push_pull_output();
    let drdy = pins.gpio37.into_pull_up_input();
